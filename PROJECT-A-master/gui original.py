...
start_menu = pygame.display.set_mode((800,700))
...
while main_menu:
    ...
    draw_text(start_menu,'Welcome to the Kights of dungeons',100,(0,0,0),105,55)
    start_menu.blit(press_enter,(200,350))
    

start_menu = pygame.display.set_mode((800,700))
pygame.display.set_caption('Knights of Dungeons')
gb_1 = pygame.image.load('background.png')
num_player = font_4.render('Press the number of players that are going to play on your keyboard',100,(0,0,0))
...
instruction_window_ = pygame.display.set_mode((800,700))
pygame.display.set_caption('Knights of Dungeons')
gb_1 = pygame.image.load('background.png')
...
Instruction_6 = font_7.render('- By pressing the enter key you will roll the dice and pass on your turn to the next player',100,(0,0,0))
note = font_5.render('Note: ',100,(0,0,0))
note_1 = font_7.render('You can only excute the above instruction only before pressing enter',100,(0,0,0))
note_2 = font_7.render('For safety purposes you have to hold the keys for 2 seconds',100,(0,0,0))
note_3 = font_7.render('Remember to use tha space key after you have defeated the boss',100,(0,0,0))
...
level_1 = [
            'pass','pick a card','pass',15,'pick a card','pick a card',15,'pass','pick a card','pass',15,
            'pick a card','pick a card',15,'pass','pick a card',15,'pass','pick a card','pick a card'
            
            ]   
level_2 = [
	'pass','Pick a card','pass',15,'Pick a card','Pick a card',15,'pass','Pick a card',
	'pass',15,'Pick a card',15,'pass','Pick a card','pass',15,'Pick a card','Pick a card',15,
	'pass','Pick a card','pass',15,'Pick a card','Pick a card',15,'pass','Pick a card','pass',15,
	'Pick a card','Pick a card',15,'pass','Pick a card','pass',15,'Pick a card','Pick a card',15,
	'pass','Pick a card','pass',15,'Pick a card','Pick a card',15,'pass','Pick a card',
	'pass',15,'Pick a card','Pick a card',15,'pass','Pick a card','pass',15,'Pick a card',
	'Pick a card',15,'pass','Pick a card','pass',15,'Pick a card','Pick a card',15,'Pick a card',
	]
level_3 = [
    'pass', 'Pick a card','pass',15, 'Pick a card','Pick a card',15,'pass','Pick a card','pass',15,'Pick a card','Pick a card',15,
    'pass','Pick a card','pass',15,'Pick a card','Pick a card',15,'pass','Pick a card','pass',15,'Pick a card','Pick a card',15,
    'pass','Pick a card','pass',15,'Pick a card','Pick a card',15,'pass','Pick a card','pass',15,'Pick a card','Pick a card',15,
    'pass','Pick a card','pass',15,'Pick a card','Pick a card',15,'pass','Pick a card','pass',15,'Pick a card','Pick a card'
	]
...
while game:
    ...
    win.blit(gb_1,(-200,0))
    win.blit(roll_dice,(700,650))
    win.blit(message_display,(10,650))
    win.blit(message_box,(10,600))
    if int(n_player[0]) ==  2:
